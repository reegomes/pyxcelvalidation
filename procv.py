...
wb = load_workbook(filename='teste.xlsx', read_only=False)
ws = wb['Sheet']
...
check1 = ws.iter_cols(min_row=linha, min_col=2, max_col=2, max_row=linha)
check2 = ws.iter_cols(min_row=linha, min_col=8, max_col=8, max_row=linha)
nnfe = ws.iter_cols(min_row=linha, min_col=7, max_col=7, max_row=linha)
